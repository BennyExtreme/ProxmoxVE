...
function getInstallCommand(scriptPath = "", isAlpine = false, useGitea = false) {
  const githubUrl = `https://raw.githubusercontent.com/BennyExtreme/${basePath}/main/${scriptPath}`;
  const giteaUrl = `https://git.BennyExtreme.org/BennyExtreme/${basePath}/raw/branch/main/${scriptPath}`;
