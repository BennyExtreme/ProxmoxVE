...
function update_script() {
  ...
  if check_for_gh_release "ProxmoxVE-Local" "BennyExtreme/ProxmoxVE-Local"; then
    ...
    CLEAN_INSTALL=1 fetch_and_deploy_gh_release "ProxmoxVE-Local" "BennyExtreme/ProxmoxVE-Local"
