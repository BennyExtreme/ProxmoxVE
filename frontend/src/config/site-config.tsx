...
export const navbarLinks = [
  {
    href: `https://github.com/BennyExtreme/${basePath}`,
    event: "GitHub",
  ...
  {
    href: `https://github.com/BennyExtreme/${basePath}/blob/main/CHANGELOG.md`,
    event: "Changelog",
  ...
  {
    href: `https://github.com/BennyExtreme/${basePath}/discussions`,
    event: "Discussions",
