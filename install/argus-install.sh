...
service:
  ...
  BennyExtreme/ProxmoxVE:
    latest_version:
      type: github
      url: BennyExtreme/ProxmoxVE
      use_prerelease: false
    dashboard:
      icon: https://raw.githubusercontent.com/BennyExtreme/ProxmoxVE/refs/heads/main/misc/images/logo.png
      icon_link_to: https://helper-scripts.com/
      web_url: https://github.com/BennyExtreme/ProxmoxVE/releases
EOF
msg_ok "Setup Config"
